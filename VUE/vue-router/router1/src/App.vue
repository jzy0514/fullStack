<template>
  <div id="app">
    ...
    <p>导航:
      ...
      <router-link to="/look/111111">看看</router-link>
      ...
      <router-link :to="{ name : 'LookTwo', params: {userId: 2} }">look2</router-link>
...
export default {
  ...
  methods: {
    go () {
      this.$router.push({ name: 'LookOne', params: { name: 'old wang' } })
    }
  }
}
</script>
